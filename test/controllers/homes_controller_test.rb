...
class HomesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create home" do
    assert_difference('Home.count') do
      post homes_url, params: { home: { address: @home.address, name: @home.name, price: @home.price, room_number: @home.room_number } }
    end
  ...
  test "should update home" do
    patch home_url(@home), params: { home: { address: @home.address, name: @home.name, price: @home.price, room_number: @home.room_number } }
